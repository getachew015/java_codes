...
public  class LinkedList<E> implements ListInterface<E>{
	...
	protected class GenericNode<E>{//An inner class Node used as helper to implement the list interface
		private E data;
		private int priority;
		private GenericNode<E> next;
		
	public GenericNode(E element, int priority){
	...
	public void display(){
		GenericNode<E> currNode = head;
			while(currNode!=null){
			System.out.print("["+currNode.priority+" "+currNode.data+"] ");//display the value of the list
			currNode=currNode.getNext();
		}
